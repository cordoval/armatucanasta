...
use Gicsdr\ArmatucanastaBundle\Entity\Unidad;
use Gicsdr\ArmatucanastaBundle\Form\UnidadType;
...
class UnidadController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('GicsdrArmatucanastaBundle:Unidad')->findAll();

        return $this->render('GicsdrArmatucanastaBundle:Unidad:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('GicsdrArmatucanastaBundle:Unidad')->find($id);
        ...
        return $this->render('GicsdrArmatucanastaBundle:Unidad:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function newAction()
    {
        ...
        return $this->render('GicsdrArmatucanastaBundle:Unidad:new.html.twig', array(
            'entity' => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('GicsdrArmatucanastaBundle:Unidad:edit.html.twig', array(
            'entity'      => $entity,
